# -*- coding: utf-8 -*-
"""
Created on Sun Oct 31 20:45:52 2021
...
csv_filename = '../EyeSocketRecognition/InceptionV3_Mask.csv'        
...
rootdir = '../EyeSocketRecognition/Dataset/Mask/train_gabor'
...
rootdir = '../EyeSocketRecognition/Dataset/Mask/test_gabor'
...
for i in range(num_runs):    
    ...
    '''
    x_train = ckta_train.astype('float32') / 255
    x_test = ckta_test.astype('float32') / 255
